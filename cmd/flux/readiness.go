...
func isObjectReadyConditionFunc(ctx context.Context, kubeClient client.Client, namespaceName types.NamespacedName, obj client.Object) wait.ConditionFunc {
...
// ready.
func isStaticObjectReadyConditionFunc(ctx context.Context, kubeClient client.Client, namespaceName types.NamespacedName, obj client.Object) wait.ConditionFunc {
	return func() (bool, error) {
		err := kubeClient.Get(ctx, namespaceName, obj)
		if err != nil {
			return false, err
